...
### Branding & Identity
-   **Global Name Change**: Updated "XMAS Event" / "크리스마스 이벤트" to **"씨씨지민 코드지갑"** (CC Jimin Code Wallet) in all titles, meta tags, and layouts.
...
- **Vault Accrual Verification**: Validated that gameplay events correctly trigger vault accrual into the locked balance.
- **Unified Leveling**: Verified synchronization between Season Pass XP and Global User XP/Leveling systems.
